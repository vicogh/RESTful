...
class FabricanteController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(!$request->input('nombre') || !$request->input('telefono'))
        {
            ...
            return response()->json(['mensaje'=> 'No se pudieron comprobar los datos', 'codigo' => 422],422);
    ...
    public function destroy($id)
    {
        ...
        {
         return response()->json(['mensaje'=> 'Este fabricante posee vehiculos asociados no puede ser eliminador. Elimine primero sus vehiculos', 'codigo' => 409],409);   
        }
